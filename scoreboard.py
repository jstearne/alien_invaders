import pygame.font
# whenever text is involved, you have to import pygame.font
...
class Scoreboard:
    ...
    def prep_score(self):
        """Turn score into a rendered image. Convert to string."""
    ...
    def prep_level(self):
        ...
        # Position the level information below the score
